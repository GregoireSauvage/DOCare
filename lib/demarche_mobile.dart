...
class _DemarcheInterfaceState extends State<DemarcheInterface> {
  ...
  Demarche demarche1 = Demarche(
    id: 1,
    name: 'Formulaire AME',
    description: "Le formulaire 11573*06 permet de faire une demande d'Aide Médicale de l'Etat (AME). Celle-ci est accordée pour 12 mois. Destinée aux étrangers en situation irrégulière (personnes sans titre de séjour...), cette aide offre sous conditions un accès aux soins gratuit, au titre des soins urgents.",
